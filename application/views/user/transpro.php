                        ...
                        function updateTable() {
                            ...
                            for (const [barcode, produk] of Object.entries(productDatabase)) {
                                ...
                                $('#barcodeInput').on('input', function() {
                                        ...
                                        let scanTimeout; $styleInput.on('input', function() {
                                            ...
                                            scanTimeout = setTimeout(function() {
                                                ...
                                                if (productDatabase[barcode]) {
                                                    const exists = $produkTable.find(
                                                            `tr td:nth-child(2):contains(${barcode})`)
                                                        .length > 0;
                                                    if (exists) {
                            							...
                            							`);
                                                        $('#totalProduk, #currentItem').text($produkTable.find(
                                                                'tr')
                                                            .length);
                                                    }
                                                } else {
